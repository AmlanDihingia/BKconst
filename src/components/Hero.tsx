    ...
    return (
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: 'url("https://images.unsplash.com/photo-1541888946425-d81bb19480c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80")',
                }}
            >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="flex flex-col items-center">
                    <motion.h2
                        ...
                        className="text-brand-blue font-bold tracking-[0.3em] uppercase text-xs md:text-sm mb-6"
                    >
                    ...
                    >
                        <Link
                            href="#contact"
                            className="w-full sm:w-auto bg-brand-blue hover:bg-white text-white hover:text-black px-12 py-5 rounded-full font-bold text-lg transition-all duration-300 transform hover:-translate-y-1 shadow-[0_0_30px_rgba(37,99,235,0.3)] text-center"
                        >
                            Start Your Project
                        </Link>
                        <Link
                            href="#services"
                            className="w-full sm:w-auto bg-white/5 backdrop-blur-md border border-white/20 hover:bg-white/10 text-white px-12 py-5 rounded-full font-bold text-lg transition-all duration-300 transform hover:-translate-y-1 text-center"
                        >
                            Explore Services
                        </Link>
                    </motion.div>
